...
my %SO = (repeat_region => "SO:0000657", long_terminal_repeat => "SO:0000286", target_site_duplication => "SO:0000434", primer_binding_site => "SO:0005850", "LTR_retrotransposon" => "SO:0000186", "Copia_LTR_retrotransposon" => "SO:0002264", "Gypsy_LTR_retrotransposon" => "SO:0002265", "LARD" => "SO:0002260", "TRIM" => "SO:0002261", "TR_GAG" => "SO:0000186", "BARE-2" => "SO:0000186" );
...
#chr03:19323647..19328532        pass    motif:TGCA      TSD:GTCGC       19323642..19323646      19328533..19328537      IN:19323854..19328325   99.03
	...
	$so = "Copia_LTR_retrotransposon" if $supfam =~ /^Copia/;
	$so = "Gypsy_LTR_retrotransposon" if $supfam =~ /^Gypsy/;
	$so = "LARD" if $supfam =~ /^LARD/ ;
        $so = "TRIM" if $supfam =~ /^TRIM/ ;
        #
     	$so = "TR_GAG" if $supfam =~ /^TR_GAG/ ;
        $so = "BARE-2" if $supfam =~ /^BARE-2/ ;   
	#
	if ($TSD eq "NA"){
